...
public class EmpManageController {
	...
	public ResponseEntity<List<EmpViewTableVO>> getList(@PathVariable("page") int page){
		Criteria cri = new Criteria(page, 10);
		return new ResponseEntity<List<EmpViewTableVO>>(service.getList(cri), HttpStatus.OK);
	}
}
