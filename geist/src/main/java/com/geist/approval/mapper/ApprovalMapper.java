...
public interface ApprovalMapper {
	...
	// 결재 조회 페이징
	public List<ApprovalReqVO> reqListWithPaging(@Param("cri") Criteria cri, @Param("emp_no") Long emp_no);
	...
	// 결재 승인 조회	
	// 결재 승인 페이징
	public List<ApprovalAgrVO> agreeListWithPaging(@Param("cri") Criteria cri, @Param("emp_no") Long emp_no);
