function ChangeMpage(value){
    ...
    {
        location.href="index.jsp?contentPage=./page/.jsp";
    }
    ...
    {
        location.href="index.jsp?contentPage=./page/attendance-page.jsp";
    }
    ...
    {
        location.href="index.jsp?contentPage=./page/admin-page.jsp";
    }
    else if(value == "11") // nav 버튼 클릭시 관리자 가입승인 화면이동
    {
        location.href="index.jsp?contentPage=./page/admin-page-approve.jsp";
    }
